...
def upgrade():
    ...
    op.create_index(
        op.f("ix_dsc_discount_id"), "dsc_discount", ["id"], unique=False
    )
    op.create_table(
        "prd_category",
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["parent_category"], ["prd_category.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name"),
    )
    op.create_index(
        op.f("ix_prd_category_id"), "prd_category", ["id"], unique=False
    )
    op.create_table(
        "usr_user",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["usr_user.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"], ["prd_category.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint("name"),
    )
    op.create_index(
        op.f("ix_prd_product_id"), "prd_product", ["id"], unique=False
    )
    op.create_table(
        "usr_token",
        sa.Column(
    ...
    op.create_table(
        ...
        sa.CheckConstraint("quantity >= 0"),
        sa.ForeignKeyConstraint(
            ["cart_id"], ["crt_cart.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["product_id"], ["prd_product.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_crt_cart_item_id"), "crt_cart_item", ["id"], unique=False
    )
    op.create_table(
        "dsc_product_discount",
        sa.Column(
            "created_at",
            sa.DateTime(),
            server_default=sa.text("now()"),
        ...
        sa.ForeignKeyConstraint(
            ["discount_id"], ["dsc_discount.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["product_id"], ["prd_product.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_dsc_product_discount_id"),
        "dsc_product_discount",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.CheckConstraint("quantity >= 0"),
        sa.ForeignKeyConstraint(
            ["order_id"], ["ord_order.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["product_id"], ["prd_product.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_ord_order_item_id"), "ord_order_item", ["id"], unique=False
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_dsc_product_discount_id"), table_name="dsc_product_discount"
    )
